...
var useParagonThemeVariants = function useParagonThemeVariants(_ref) {
  ...
  useEffect(function () {
    ...
    Object.entries(themeVariants).forEach(function (_ref2) {
      ...
      var existingThemeVariantLink = document.head.querySelector("link[href='".concat(value.urls["default"], "'][rel=stylesheet]"));
      var existingThemeVariantBrandLink = document.head.querySelector("link[href='".concat(value.urls.brandOverride, "'][rel=stylesheet]"));
