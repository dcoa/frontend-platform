 ...
 *
 */
export function changeUserSessionLanguage(_x) {
  return _changeUserSessionLanguage.apply(this, arguments);
}
function _changeUserSessionLanguage() {
  _changeUserSessionLanguage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(languageCode) {
    var forceReload,
      cookies,
      cookieName,
      user,
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          cookies = getCookies();
          cookieName = getConfig().LANGUAGE_PREFERENCE_COOKIE_NAME;
          ...
          _context.next = 9;
          return updateUserPreferences(user.username, {
            prefLang: languageCode
          });
        case 9:
          _context.next = 11;
          return setSessionLanguage(languageCode);
        case 11:
