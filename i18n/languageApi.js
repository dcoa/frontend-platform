 ...
 */
export function updateUserPreferences(_x, _x2) {
 ...
 *                      or rejects if there's an error with the request.
 */
function _updateUserPreferences() {
  _updateUserPreferences = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(username, preferenceData) {
    var snakeCaseData, formattedData;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          snakeCaseData = snakeCaseObject(preferenceData);
          formattedData = convertKeyNames(snakeCaseData, {
            pref_lang: 'pref-lang'
          });
          return _context.abrupt("return", getAuthenticatedHttpClient().patch("".concat(getConfig().LMS_BASE_URL, "/api/user/v1/preferences/").concat(username), formattedData, {
            headers: {
...
export function setSessionLanguage(_x3) {
  return _setSessionLanguage.apply(this, arguments);
}
function _setSessionLanguage() {
  _setSessionLanguage = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(languageCode) {
    var formData;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", getAuthenticatedHttpClient().post("".concat(getConfig().LMS_BASE_URL, "/i18n/setlang/"), formData, {
            headers: {
